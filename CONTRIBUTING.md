...
some other ruleset that depends on rules_vite, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_vite=$(pwd)/rules_vite"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_vite` on your system will point to this folder.
...
https://github.com/xangcastle/rules_vite/actions/workflows/tag.yaml
