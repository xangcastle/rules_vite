...
1. search for "com_xangcastle_rules_vite" and replace with the name you'll use for your workspace
1. search for "xangcastle" and replace with GitHub org
1. search for "vite", "Vite", "VITE" and replace with the language/tool your rules are for
1. rename directory "vite" similarly
...
<https://github.com/xangcastle/rules_vite/releases>
...
1. Replace `url = "https://github.com/xangcastle/rules_vite/releases/download/v0.1.0/rules_vite-v0.1.0.tar.gz"` with a GitHub-provided source archive like `url = "https://github.com/xangcastle/rules_vite/archive/abc123.tar.gz"`
1. Replace `strip_prefix = "rules_vite-0.1.0"` with `strip_prefix = "rules_vite-abc123"`
