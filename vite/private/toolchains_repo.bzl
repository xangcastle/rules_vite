...
# By default all these toolchains are registered by the vite_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:vite_toolchain",
    toolchain_type = "@com_xangcastle_rules_vite//vite:toolchain_type",
)
""".format(
            platform = platform,
